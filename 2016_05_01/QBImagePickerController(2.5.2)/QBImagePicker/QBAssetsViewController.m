...
- (BOOL)isMaximumSelectionLimitReached
{
    ...
    if (minimumNumberOfSelection <= self.imagePickerController.maximumNumberOfSelection) {
        BOOL ok = (self.imagePickerController.maximumNumberOfSelection <= self.imagePickerController.selectedAssetURLs.count);
        if (ok) {
            if ([self.imagePickerController.delegate respondsToSelector:@selector(qb_imagePickerControllerMaximumSelectionLimitReached:)]) {
                [self.imagePickerController.delegate qb_imagePickerControllerMaximumSelectionLimitReached:self.imagePickerController];
            }
        }
        return ok;
    }
