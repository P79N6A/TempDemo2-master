...
@interface DetailVC6 () <UITableViewDelegate, UITableViewDataSource>
{
    // 定时器
    NSTimer * _timer;
}
...
- (void)createUI
{
    UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(20, 60, 280, 280)];
...
//    button.frame = CGRectMake(50, 240+60, 220, 50);
...
//    {
//        self.title = [NSString stringWithFormat:@"%@(%d)", self.navigationController.title, self.navigationController.viewControllers.count];
//    }
//    else
//    {
//        self.title = [NSString stringWithFormat:@"%@", self.navigationController.title];
//    }
...
{
    NSLog(@"pressBtn:");
    DetailVC6 *ctl = [[DetailVC6 alloc] init];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    DetailVC6 *detail = [[DetailVC6 alloc] init];
