...
根据地址名称获取地理信息 异步函数，返回结果在\-B\-M\-K\-Search\-Delegate的on\-Get\-Addr\-Result通知 
\begin{DoxyParams}{参数}
{\em addr} & 地址信息 \\
\hline
{\em city} & 城市名称 \\
...
每页容量 
\end{DoxyReturn}
\hypertarget{interface_b_m_k_search_aa8d9cd82853ef5c350fdb1f401e7b061}{\index{B\-M\-K\-Search@{B\-M\-K\-Search}!poi\-Detail\-Share\-Url\-:@{poi\-Detail\-Share\-Url\-:}}
\index{poi\-Detail\-Share\-Url\-:@{poi\-Detail\-Share\-Url\-:}!BMKSearch@{B\-M\-K\-Search}}
\subsubsection[{poi\-Detail\-Share\-Url\-:}]{\setlength{\rightskip}{0pt plus 5cm}-\/ (B\-O\-O\-L) poi\-Detail\-Share\-Url\-: 
\begin{DoxyParamCaption}
\item[{(N\-S\-String $\ast$)}]{uid}
\end{DoxyParamCaption}
}}\label{interface_b_m_k_search_aa8d9cd82853ef5c350fdb1f401e7b061}
...
根据地理坐标获取地址信息 异步函数，返回结果在\-B\-M\-K\-Search\-Delegate的on\-Get\-Addr\-Result通知 
\begin{DoxyParams}{参数}
{\em center} & 点坐标 \\
\hline
\end{DoxyParams}
...
成功返回\-Y\-E\-S，否则返回\-N\-O 
\end{DoxyReturn}
\hypertarget{interface_b_m_k_search_af6465436fb7bd5f89382ce29ae2ae6b4}{\index{B\-M\-K\-Search@{B\-M\-K\-Search}!reverse\-Geo\-Share\-Url\-:poi\-Name\-:poi\-Address\-:@{reverse\-Geo\-Share\-Url\-:poi\-Name\-:poi\-Address\-:}}
\index{reverse\-Geo\-Share\-Url\-:poi\-Name\-:poi\-Address\-:@{reverse\-Geo\-Share\-Url\-:poi\-Name\-:poi\-Address\-:}!BMKSearch@{B\-M\-K\-Search}}
\subsubsection[{reverse\-Geo\-Share\-Url\-:poi\-Name\-:poi\-Address\-:}]{\setlength{\rightskip}{0pt plus 5cm}-\/ (B\-O\-O\-L) reverse\-Geo\-Share\-Url\-: 
\begin{DoxyParamCaption}
\item[{(C\-L\-Location\-Coordinate2\-D)}]{coor}
\item[{poiName:(N\-S\-String $\ast$)}]{name}
\item[{poiAddress:(N\-S\-String $\ast$)}]{address}
\end{DoxyParamCaption}
}}\label{interface_b_m_k_search_af6465436fb7bd5f89382ce29ae2ae6b4}
获取反geo短串分享url 异步函数，返回结果在\-B\-M\-K\-Search\-Delegate的on\-Get\-Share\-Url通知 
\begin{DoxyParams}{参数}
{\em coor} & 经纬度坐标 \\
\hline
{\em name} & 标题 \\
...
搜索建议检索 
\begin{DoxyParams}{参数}
{\em key} & 搜索建议的检索关键字 异步函数，返回结果在\-B\-M\-K\-Search\-Delegate的on\-Get\-Suggestion\-Result通知 \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{返回}
成功返回\-Y\-E\-S，否则返回\-N\-O 
...
特定城市内搜索建议检索 异步函数，返回结果在\-B\-M\-K\-Search\-Delegate的on\-Get\-Suggestion\-Result通知 
\begin{DoxyParams}{参数}
{\em key} & 搜索建议的检索关键字 \\
\hline
...
公交路线检索 异步函数，返回结果在\-B\-M\-K\-Search\-Delegate的on\-Get\-Transit\-Route\-Result通知 
\begin{DoxyParams}{参数}
{\em city} & 城市名，用于在哪个城市内进行检索 \\
\hline
{\em start} & 检索的起点，可通过关键字、坐标两种方式指定 \\
