百度地图iOS SDK v2.1.1 Sample共有15个Demo,每个Demo的说明如下：

-------------------------------------------------------------------------------------
一、
Demo名称：基本地图功能
文件名：  MapViewBaseDemoViewController.m
...
二、
Demo名称：图层展示功能
文件名：  MapViewDemoViewController.m
...
三、
Demo名称：地图操作功能
文件名：  MapViewControlDemoViewController.m
...
四、
Demo名称：UI控制功能
文件名：  MapViewUISettingDemoViewController.m
...
十三、
Demo名称：短串分享功能
文件名：  ShortUrlShareDemoViewController.m
...
十四、
Demo名称：LBS.云检索
文件名：  CloudSearchDemoViewController.m
...
十五、
Demo名称：调启百度导航功能
文件名：NavigationDemoViewController.m
