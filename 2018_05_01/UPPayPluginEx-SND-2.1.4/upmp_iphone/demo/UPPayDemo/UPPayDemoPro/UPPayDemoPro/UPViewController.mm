...
- (void)viewDidLoad
{
    ...
    self.title = kVCTitle;
    self.mode = @"01";
    self.tnURL = @"http://202.101.25.178:8080/sim/gettn";
    self.configURL = @"http://202.101.25.178:8080/sim/app.jsp?user=123456789";
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection
{
    ...
    {
        NSLog(@"tn=%@",tn);
        [UPPayPluginPro startPay:tn mode:self.mode viewController:self delegate:self];
    }
    [tn release];
    [connection release];
    connection = nil;
