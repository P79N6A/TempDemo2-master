...
- (void)viewDidLoad
{
    ...
    [imgView setFrame:CGRectMake(0, 0, 320, 460)];
    [self.view addSubview:imgView];
    
    DCPathButton *dcPathButton = [[DCPathButton alloc]initDCPathButtonWithSubButtons:6 totalRadius:60 centerRadius:15 subRadius:15 centerImage:@"custom_center" centerBackground:nil subImages:^(DCPathButton *dc){
    ...
    }subImageBackground:nil inLocationX:0 locationY:0 toParentView:self.view];
