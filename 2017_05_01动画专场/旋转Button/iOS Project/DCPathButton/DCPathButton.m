...
- (void)configureTheButtons:(NSInteger)buttonCount{
    ...
    switch (buttonCount) {
        case 3:
        {
            kDCPathButtonSubButtonTag_0_AppearLocation = CGPointMake( self.centerLocationAxisX - self.totalRaiuds * sinf(kDCCovertAngelToRadian(kDCPathButtonAngel60C)), self.centerLocationAxisY - self.totalRaiuds * cosf(kDCCovertAngelToRadian(kDCPathButtonAngel60C)));
            kDCPathButtonSubButtonTag_1_AppearLocation = CGPointMake( self.centerLocationAxisX + self.totalRaiuds * sinf(kDCCovertAngelToRadian(kDCPathButtonAngel60C)), self.centerLocationAxisY - self.totalRaiuds * cosf(kDCCovertAngelToRadian(kDCPathButtonAngel60C)));
            kDCPathButtonSubButtonTag_2_AppearLocation = CGPointMake( self.centerLocationAxisX , self.centerLocationAxisY +self.totalRaiuds);
        }
            break;
        case 4:
        {
            kDCPathButtonSubButtonTag_0_AppearLocation = CGPointMake( self.centerLocationAxisX - self.totalRaiuds * sinf(kDCCovertAngelToRadian(kDCPathButtonAngel45C)), self.centerLocationAxisY - self.totalRaiuds * cosf(kDCCovertAngelToRadian(kDCPathButtonAngel45C)));
            kDCPathButtonSubButtonTag_1_AppearLocation = CGPointMake( self.centerLocationAxisX + self.totalRaiuds * sinf(kDCCovertAngelToRadian(kDCPathButtonAngel45C)), self.centerLocationAxisY - self.totalRaiuds * cosf(kDCCovertAngelToRadian(kDCPathButtonAngel45C)));
            kDCPathButtonSubButtonTag_2_AppearLocation = CGPointMake( self.centerLocationAxisX - self.totalRaiuds * sinf(kDCCovertAngelToRadian(kDCPathButtonAngel45C)), self.centerLocationAxisY + self.totalRaiuds * cosf(kDCCovertAngelToRadian(kDCPathButtonAngel45C)));
            kDCPathButtonSubButtonTag_3_AppearLocation = CGPointMake( self.centerLocationAxisX + self.totalRaiuds * sinf(kDCCovertAngelToRadian(kDCPathButtonAngel45C)), self.centerLocationAxisY + self.totalRaiuds * cosf(kDCCovertAngelToRadian(kDCPathButtonAngel45C)));
        }
            break;
        case 5:
        {
            kDCPathButtonSubButtonTag_0_AppearLocation = CGPointMake( self.centerLocationAxisX - self.totalRaiuds * sinf(kDCCovertAngelToRadian(kDCPathButtonAngel36C)), self.centerLocationAxisY - self.totalRaiuds * cosf(kDCCovertAngelToRadian(kDCPathButtonAngel36C)));
            kDCPathButtonSubButtonTag_1_AppearLocation = CGPointMake( self.centerLocationAxisX + self.totalRaiuds * sinf(kDCCovertAngelToRadian(kDCPathButtonAngel36C)), self.centerLocationAxisY - self.totalRaiuds * cosf(kDCCovertAngelToRadian(kDCPathButtonAngel36C)));
            kDCPathButtonSubButtonTag_2_AppearLocation = CGPointMake( self.centerLocationAxisX - self.totalRaiuds * sinf(kDCCovertAngelToRadian(kDCPathButtonAngel72C)), self.centerLocationAxisY + self.totalRaiuds * cosf(kDCCovertAngelToRadian(kDCPathButtonAngel72C)));
            kDCPathButtonSubButtonTag_3_AppearLocation = CGPointMake( self.centerLocationAxisX, self.centerLocationAxisY + self.totalRaiuds);
            kDCPathButtonSubButtonTag_4_AppearLocation = CGPointMake( self.centerLocationAxisX + self.totalRaiuds * sinf(kDCCovertAngelToRadian(kDCPathButtonAngel72C)), self.centerLocationAxisY + self.totalRaiuds * cosf(kDCCovertAngelToRadian(kDCPathButtonAngel72C)));
        }
            break;
        case 6:
        {
            kDCPathButtonSubButtonTag_0_AppearLocation = CGPointMake( self.centerLocationAxisX - self.totalRaiuds * sinf(kDCCovertAngelToRadian(kDCPathButtonAngel60C)), self.centerLocationAxisY - self.totalRaiuds * cosf(kDCCovertAngelToRadian(kDCPathButtonAngel60C)));
            kDCPathButtonSubButtonTag_1_AppearLocation = CGPointMake( self.centerLocationAxisX, self.centerLocationAxisY - self.totalRaiuds);
            kDCPathButtonSubButtonTag_2_AppearLocation = CGPointMake( self.centerLocationAxisX + self.totalRaiuds * sinf(kDCCovertAngelToRadian(kDCPathButtonAngel60C)), self.centerLocationAxisY - self.totalRaiuds * cosf(kDCCovertAngelToRadian(kDCPathButtonAngel60C)));
            kDCPathButtonSubButtonTag_3_AppearLocation = CGPointMake( self.centerLocationAxisX - self.totalRaiuds * sinf(kDCCovertAngelToRadian(kDCPathButtonAngel60C)), self.centerLocationAxisY + self.totalRaiuds * cosf(kDCCovertAngelToRadian(kDCPathButtonAngel60C)));
            kDCPathButtonSubButtonTag_4_AppearLocation = CGPointMake( self.centerLocationAxisX, self.centerLocationAxisY + self.totalRaiuds);
            kDCPathButtonSubButtonTag_5_AppearLocation = CGPointMake( self.centerLocationAxisX + self.totalRaiuds * sinf(kDCCovertAngelToRadian(kDCPathButtonAngel60C)), self.centerLocationAxisY + self.totalRaiuds * cosf(kDCCovertAngelToRadian(kDCPathButtonAngel60C)));
        }
            break;
        default:
            break;
